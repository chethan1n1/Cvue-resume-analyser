...
const Upload = () => {
    ...
    return (
        <main className="bg-neutral-100 min-h-screen">
            ...
            <section className="main-section flex flex-col md:flex-row gap-8 items-start justify-center">
                {/* Resume Preview Box */}
                <div className="w-full md:w-1/2 bg-white rounded-xl border border-gray-200 shadow-sm p-8 flex flex-col items-center justify-center min-h-[400px]">
                    ...
                    {file ? (
                        ...
                        <div className="flex flex-col items-center justify-center h-full text-gray-400">
                            <p>No resume selected. Upload a PDF to preview.</p>
                        </div>
                    )}
                </div>
